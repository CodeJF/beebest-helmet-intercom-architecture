...
- [1. 目标](#1-目标)
- [2. 官方公开能力边界](#2-官方公开能力边界)
- [3. 关键实现结论](#3-关键实现结论)
- [4. 总体架构](#4-总体架构)
- [5. 推荐硬件与协议选型](#5-推荐硬件与协议选型)
- [6. 复刻系统的核心设计原则](#6-复刻系统的核心设计原则)
- [7. 设备名称与双蓝牙身份模型](#7-设备名称与双蓝牙身份模型)
- [8. 前后座对讲实现方案](#8-前后座对讲实现方案)
- [9. Mesh 组队与多人通话实现方案](#9-mesh-组队与多人通话实现方案)
- [10. 前后座加入群聊的闭合方案](#10-前后座加入群聊的闭合方案)
- [11. 音频优先级与混音策略](#11-音频优先级与混音策略)
- [12. App 侧职责拆分](#12-app-侧职责拆分)
- [13. 固件侧职责拆分](#13-固件侧职责拆分)
- [14. 建议的 BLE GATT 模型](#14-建议的-ble-gatt-模型)
- [15. 命令协议建议](#15-命令协议建议)
- [16. 关键状态机建议](#16-关键状态机建议)
- [17. 容量时延与稳定性目标](#17-容量时延与稳定性目标)
- [18. 兼容性策略](#18-兼容性策略)
- [19. 测试方案](#19-测试方案)
- [20. 风险与工程难点](#20-风险与工程难点)
- [21. 最小可行版本路线图](#21-最小可行版本路线图)
- [22. 最终实现摘要](#22-最终实现摘要)
- [23. 资料来源](#23-资料来源)
- [24. 使用说明](#24-使用说明)
